...
public class UpdateSmartphoneController implements Initializable {
    ...
    public void setSmartphoneData(Smartphone smartphone) {
        idTf.setText(String.valueOf(smartphone.getId()));
        brandTf.setText(smartphone.getBrand());
        modelTf.setText(smartphone.getModel());
        priceTf.setText(String.valueOf(smartphone.getPrice()));
        listC.add(smartphone.getCategory().getNom());
